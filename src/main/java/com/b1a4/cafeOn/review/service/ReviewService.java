...
public class ReviewService {
    ...
    // 특정 카페 전체 리뷰 조회
    public Page<ReviewDTO> getAllReviewByCafeId(String userId, Long cafeId, Pageable pageable) {
    ...
    // 특정 리뷰 조회
    public ReviewDTO getReview(String userId, Long cafeId, Long reviewId) {
        ReviewEntity review = reviewRepository.findById(reviewId)
                .orElseThrow(() -> new ReviewNotFoundException(reviewId));
